            ...
            >
              <div className="flex items-start justify-between gap-3">
                  ...
                  {editingId === project.id ? (
                    <div className="flex items-center gap-2 flex-1">
                      <input
                        ...
                        maxLength={64}
                        className="w-full min-w-0 rounded-lg border border-[var(--border)] bg-[var(--background)] px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        autoFocus
                      />
                      <button
                      ...
                      <button
                        ...
                        className="rounded-lg border border-[var(--border)] px-2.5 py-1.5 text-xs font-medium hover:bg-zinc-50 dark:hover:bg-zinc-900"
                      >
                        Cancel
                      </button>
                    </div>
                ...
                <button
                  ...
                  className="rounded-lg border border-[var(--border)] px-2.5 py-1.5 text-xs font-medium text-zinc-500 hover:text-zinc-800 hover:bg-zinc-50 dark:hover:text-zinc-200 dark:hover:bg-zinc-900 transition-colors"
                >
                  Rename
                </button>
              </div>
