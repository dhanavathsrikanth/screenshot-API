    ...
    <div className="flex h-full flex-col">
      <div className="flex-1 overflow-y-auto px-3 py-4">
        <nav className="space-y-1">
          <p className="px-3 mb-2 text-[10px] font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">
            Dashboard
          </p>
...
export function DashboardSidebar() {
  return (
    <aside className="hidden lg:flex lg:w-64 lg:flex-col lg:border-r border-[var(--border)] bg-[var(--background)] lg:fixed lg:inset-y-0 lg:top-16 z-30">
      <SidebarContent />
    </aside>
  );
}
...
export function MobileSidebar({
  ...
  return (
    <>
      ...
      <div
        className={`lg:hidden fixed inset-y-0 left-0 z-50 w-72 bg-[var(--background)] border-r border-[var(--border)] transform transition-transform duration-200 ease-in-out ${
      ...
      >
        <div className="flex items-center justify-between px-4 h-16 border-b border-[var(--border)]">
          ...
          <button
            onClick={onClose}
            className="rounded-lg p-1.5 text-zinc-500 hover:text-zinc-700 hover:bg-zinc-100 dark:hover:text-zinc-300 dark:hover:bg-zinc-800 transition-colors"
