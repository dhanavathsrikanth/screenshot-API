...
export function UpgradeButton({
  ...
  return (
    <button
      onClick={openUpgradeDialog}
      className={`inline-flex items-center gap-1.5 rounded-lg bg-indigo-600 px-3.5 py-2 text-sm font-medium text-white hover:bg-indigo-700 transition-colors shadow-sm ${className}`}
    >
